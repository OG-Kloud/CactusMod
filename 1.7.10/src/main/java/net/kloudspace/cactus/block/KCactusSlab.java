...
//BlockSlab
public class KCactusSlab extends KSlab {

	public static final String[] field_150006_b = new String[] {"cactus"};
    @SideOnly(Side.CLIENT)
    private IIcon field_150007_M;
    
	protected KCactusSlab(boolean p_i45410_1_) {
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon(Reference.MODID +":" +"cactus_top");
        this.field_150007_M = p_149651_1_.registerIcon(Reference.MODID +":" +"cactusslab_side");
    }

    public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_)
    {
        return Item.getItemFromBlock(KBlocks.double_cactusslab);
    }
    ...
    {
        return new ItemStack(Item.getItemFromBlock(KBlocks.cactusSlab), 2, p_149644_1_ & 7);
    }
