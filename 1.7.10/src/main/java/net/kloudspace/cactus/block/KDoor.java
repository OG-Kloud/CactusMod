...
public class KDoor extends Block {
	//BlockDoor
	...
	protected KDoor(Material material, String name) {
		super(material);
    ...
    public IIcon getIcon(IBlockAccess p_149673_1_, int p_149673_2_, int p_149673_3_, int p_149673_4_, int p_149673_5_)
    {
        if (p_149673_5_ != 1 && p_149673_5_ != 0)
        {
            ...
            return flag2 ? this.listA[flag1?1:0] : this.listB[flag1?1:0];
        }
        else
        {
            return this.listB[0];
    ...
    {
        this.listA = new IIcon[2];
        this.listB = new IIcon[2];
        this.listA[0] = p_149651_1_.registerIcon(this.getTextureName() + "_upper");
        this.listB[0] = p_149651_1_.registerIcon(this.getTextureName() + "_lower");
        this.listA[1] = new IconFlipped(this.listA[0], true, false);
        this.listB[1] = new IconFlipped(this.listB[0], true, false);
    }
