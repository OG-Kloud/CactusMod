...
public class FurnaceContainer extends BlockContainer {
	...
	public FurnaceContainer(boolean isActive) {
		super(Material.rock);
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_)
    {
        ...
        this.front = p_149651_1_.registerIcon(this.isActive ? Reference.folder+"cactusFurnace_lit" : Reference.folder+"cactusFurnace");
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack)
	{
		...
		{
			((TileEntityCactusFurnace)par1World.getTileEntity(par2, par3, par4)).setGuiDisplayName(par6ItemStack.getDisplayName());
		}
	}
    public void breakBlock(World par1World, int par2, int par3, int par4, Block par5, int par6)
	{
		if (!keep)
		{
			TileEntityCactusFurnace tileEntityFurnace = (TileEntityCactusFurnace)par1World.getTileEntity(par2, par3, par4);
			...
			if (tileEntityFurnace != null)
			{
				...
				par1World.func_147453_f(par2, par3, par4, KBlocks.cactusFurnace);
