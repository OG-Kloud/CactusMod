...
public class ContainerHalf extends Container {
	
	private HalfFurnace tileFurnace;
	private int lastCookTime;
	private int lastBurnTime;
	private int lastItemBurnTime;
	
	public ContainerHalf(InventoryPlayer p_i1812_1_, HalfFurnace p_i1812_2_) {
	...
	public ItemStack transferStackInSlot(EntityPlayer p_82846_1_, int p_82846_2_) {
		...
		if (slot != null && slot.getHasStack()) {
			...
			if (p_82846_2_ == 2) {
				...
				else if (HalfFurnace.isItemFuel(itemstack1)) {
