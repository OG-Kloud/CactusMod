...
public class RenderCactusTNT extends Render {
     ...
     */
    public void doRender(EntityCactusTNT p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
        GL11.glPushMatrix();
        ...
        this.blockRenderer.renderBlockAsItem(KBlocks.cactusTNT, 0, p_76986_1_.getBrightness(p_76986_9_));
     ...
     */
    protected ResourceLocation getEntityTexture(EntityCactusTNT p_110775_1_)
    {
    ...
    {
        return this.getEntityTexture((EntityCactusTNT)p_110775_1_);
    }
