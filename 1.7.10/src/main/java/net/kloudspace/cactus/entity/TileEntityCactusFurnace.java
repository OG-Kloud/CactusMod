...
public class TileEntityCactusFurnace extends TileEntity implements ISidedInventory {
	...
	static {
		addMapping(TileEntityCactusFurnace.class, "Cactus Furnace");
	}
	...
	private String field_94130_e = "Cactus Oven";
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                FurnaceContainer.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
