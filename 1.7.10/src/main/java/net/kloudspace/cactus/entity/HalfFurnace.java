package net.kloudspace.cactus.entity;
...
public class HalfFurnace extends TileEntity implements ISidedInventory {
	...
	private String field_94130_e = "Compressed Sand Oven";
    ...
    public void readFromNBT(NBTTagCompound p_145839_1_)
    {
        ...
        this.currentItemBurnTime = getItemBurnTime(this.furnaceItemStacks[1])/2;
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                HalfContainer.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
        ...
        if(cooks == 16) {
        	this.worldObj.setBlock(xCoord, yCoord, zCoord, Blocks.glass);
        }
    }
